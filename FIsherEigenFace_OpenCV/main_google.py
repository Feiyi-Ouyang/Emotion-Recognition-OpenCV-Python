# look deeper into: which expression most distinguishable; conditions of correct classification of cameras 
...
dataPath="/Users/ouyan103/Google Drive/Scripts/OpenCVLearning/Python/emotionDet/fisherDet/googleset"
savePath="/Users/ouyan103/Google Drive/Scripts/OpenCVLearning/Python/emotionDet/fisherDet"
os.chdir(dataPath)
# targetEmotion=["anger","disgust","fear","happy","neutral","sadness","surprise"]
targetEmotion=["disgust","happy","neutral","surprise"]
...
for emotion in targetEmotion:
  for imgName in glob.glob("./%s/*" %emotion):
...
os.chdir(savePath)
fisherFace.save("./fisherFace_google.xml")
eigenFace.save("./eigenFace_google.xml")
